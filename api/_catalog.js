...
const PRODUCTS = [
     ...
     // localStorage cb3d_admin_products) e espelhados aqui manualmente.
     // id/name/price/dimensões copiados exatamente do cadastro do admin.
     // Sempre que um produto novo for cadastrado no painel, ele precisa
     // ser adicionado aqui também (ver item 15/claude/site-progresso.md
     // — ainda não é automático).
     //
     // Atualizado em 04/09: catálogo ressincronizado depois que o site
     // ganhou domínio próprio (criativobrasil3d.com.br) — o cadastro do
     // painel só existia no localStorage do domínio antigo da Vercel, e
     // precisou ser migrado pro domínio novo (ver claude/site-progresso.md,
     // "Atualização de 04/09"). Nessa checagem, "Pantera (Jaguar) com Base"
     // não existe mais no cadastro (foi removida pelo usuário) e dois
     // produtos novos apareceram (Portão Cartão, Cruz Vazada); os preços do
     // Letreiro e do Suporte também mudaram desde a sincronização de 26/08.
     // O peso do Suporte PS5/PS4 estava gravado como 86 kg no cadastro —
     // corrigido aqui para 0,86 kg (erro de digitação: faltava o ponto
     // decimal — confirmado com o usuário).
   { id: 'p1787945732698', name: 'Portão Cartão (Pode Personalizar)', cat: 'escritorio', price: 14.99, promo: null, weight_kg: 0.3, length_cm: 10, width_cm: 2.2, height_cm: 3.1 },
   { id: 'p1787943475591', name: 'Cruz Vazada', cat: 'artigo-religioso', price: 18.99, promo: null, weight_kg: 0.4, length_cm: 17, width_cm: 12.5, height_cm: 4 },
   { id: 'p1787343733424', name: 'Letreiro Cristo Vive', cat: 'artigo-religioso', price: 22, promo: null, weight_kg: 0.86, length_cm: 16, width_cm: 11, height_cm: 6 },
   { id: 'p1787287049399', name: 'Suporte para 2 Controles PS5/PS4 Branco e Preto', cat: 'games', price: 20.99, promo: null, weight_kg: 0.86, length_cm: 16, width_cm: 11, height_cm: 6 },
